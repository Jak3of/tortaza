...
public class Usuario {
	...
	@NotBlank
	@Size(min=18,max = 100, message = "este campo acepta mas de 18 y menos de 100 digitos")
	...
	public Usuario(Integer id_usuario, String contrasena, String nombre, String apellido, String direccion_inicial,
			Integer dni, String correo, Boolean estadousuario, List<Pedido> pedido,Cart cart) {
